...
### Phase A — Un-break production & harden payments _(small diffs, highest stakes)_
...
### Phase B — Card generator + email delivery _(the feature)_
...
### Phase C — Debt burn-down _(makes everything after cheaper)_
...
### Phase D — Performance _(measured before/after, see PERFORMANCE_AUDIT.md)_
