...
export default function AdminDashboard() {
  ...
  const fetchDashboardStats = async () => {
    try {
      const [membersRes, newsRes, archivesRes, contactsRes, newslettersRes, usersRes] =
        await Promise.all([
  ...
  const quickActions = [
    ...
    },
    {
      ...
      bg: 'bg-indigo-50',
      count: stats.recentUsers.length,
    },
  ]
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className="text-[var(--otjm-red)] hover:bg-[var(--otjm-red)]/5"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl border p-4">
            ...
            <div className="text-xs text-gray-400 mt-1">
              {stats.totalNewsletters} abonnés newsletter
            </div>
          </div>
        </div>
          ...
          {quickActions.map((a) => (
            ...
            >
              <CardContent className="p-5">
                ...
                <h3 className="font-semibold text-gray-900 group-hover:text-[var(--otjm-red)] transition-colors">
                  {a.label}
                </h3>
            ...
            <Card className="border-0 shadow-sm">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" variant="outline" onClick={() => router.push('/admin/members')}>
                    Voir tout
                  </Button>
                </div>
              </CardHeader>
                    ...
                    {stats.recentContacts.map((c: any) => (
                      <div key={c.id} className="py-3">
                        <div className="flex items-start justify-between">
                          ...
                          <Badge
                            variant={c.status === 'unread' ? 'destructive' : 'secondary'}
                            className="text-xs shrink-0 ml-3"
                          >
