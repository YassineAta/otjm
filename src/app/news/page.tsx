...
function CategoryBadge({ category }: { category?: string }) {
  ...
  if (!cfg)
    return (
      <span className="text-xs text-[var(--otjm-text-muted)] uppercase tracking-wider">
        {label}
      </span>
    )
  return (
    <span
      className={`inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider ${cfg.color}`}
    >
  ...
  return (
    ...
    >
      ...
      <main id="main-content">
        ...
        <section className="relative bg-[var(--otjm-dark)] text-white border-b border-white/10">
          ...
          <div className="container mx-auto px-4 max-w-6xl py-14">
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.h1
                variants={fadeUp}
                className="font-editorial text-4xl md:text-5xl font-black leading-tight mb-4"
              >
                {t.news.title}
              </motion.h1>
        ...
        <div
          style={{
            background: 'var(--otjm-bg)',
            borderBottom: isDark ? '1px solid rgba(255,255,255,0.06)' : '1px solid #E5E1DC',
          }}
        >
        ...
        <div className="container mx-auto px-4 max-w-6xl py-12" aria-live="polite">
          ...
          {!loading && !error && filtered.length === 0 && (
            <div className="text-center py-24">
              <FileText
                ...
                style={{ color: 'var(--otjm-text-muted)' }}
              />
              <p className="font-semibold" style={{ color: 'var(--otjm-text)' }}>
                {t.news.noResults}
              </p>
          ...
          {!loading && !error && filtered.length > 0 && (
            <motion.div
              initial="hidden"
              animate="visible"
              variants={prefersReduced ? staggerReduced : stagger}
            >
              {/* Featured article */}
              {featured && (
                <motion.article
                ...
                >
                  ...
                  <div
                    className={`${featured.imageUrl ? 'md:col-span-3' : 'md:col-span-5'} p-8 flex flex-col justify-between`}
                  >
                    <div>
                      ...
                      <h2
                        className="font-editorial text-2xl md:text-3xl font-bold leading-snug mb-3 group-hover:text-[var(--otjm-red)] transition-colors"
                  ...
                  {rest.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col flex-1 p-5">
                        ...
                        <h3
                          className="font-editorial text-lg font-bold mt-2 mb-2 leading-snug line-clamp-3 group-hover:text-[var(--otjm-red)] transition-colors"
                          style={{ color: 'var(--otjm-text)' }}
                        >
                          {item.title}
                        </h3>
