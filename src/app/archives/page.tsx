                ...
                <div className="flex gap-1.5 overflow-x-auto scrollbar-none pb-1">
                  {YEARS.map((y) => (
                    <button
                      ...
                      style={{
                        background:
                          activeDateFilter === y ? 'rgba(255,255,255,0.12)' : 'transparent',
                        borderColor:
                          activeDateFilter === y
                            ? 'rgba(255,255,255,0.3)'
                            : isDark
                              ...
                              : '#E5E1DC',
                        color:
                          activeDateFilter === y ? 'var(--otjm-text)' : 'var(--otjm-text-muted)',
                      }}
                    >
                      {yearLabels[y] || y}
                    </button>
                  ...
                  {filtered.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h3
                          className="font-semibold text-sm leading-snug mb-1 group-hover:text-[var(--otjm-red)] transition-colors"
