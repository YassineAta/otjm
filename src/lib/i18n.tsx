...
const fr = {
  ...
  footer: {
    ...
    contact: 'Contact',
    address: 'Rue 9 avril, Bab Saadoun, Tunis 1002',
    press: 'Presse',
...
const ar: typeof fr = {
  ...
  footer: {
    ...
    navigation: 'التنقل',
    contact: 'التواصل',
    address: 'شارع 9 أفريل، باب سعدون، تونس 1002',
    press: 'الإعلام',
  ...
  membership: {
    ...
    title: 'انضم',
    titleAccent: 'إلى الحركة.',
    subtitle: 'انتسابك ليس مجرد اشتراك. إنه فعل تضامن مهني — التزام من أجل ظروف عمل كريمة لجميع الأطباء الشبان في تونس.',
    stats: ['أكثر من 1200 عضو نشط', '12 ولاية', 'حملة نشطة 2025'],
    stepsLabel: 'كيفية الانتساب',
    ...
    faq: [
      {
        q: 'من يمكنه الانتساب إلى OTJM؟',
        a: 'يمكن لأي طالب طب (دور خارجي) أو مقيم داخلي أو متخصص في التدريب مسجل في مؤسسة تونسية الانتساب إلى OTJM.',
      },
      {
        q: 'هل الانتساب صالح طوال العام؟',
        a: 'نعم. الانتساب صالح للسنة الجامعية 2025–2026 (من لحظة التسجيل حتى 31 يوليو 2026).',
      },
      {
    ...
    ctaTitle: 'مستعد للانضمام إلى الحركة؟',
    ctaDesc: 'كل انتساب يعزز قدرتنا التفاوضية. انضم إلى أكثر من 1200 عضو نشط.',
    ctaBtn: 'انضم الآن',
  },
  home: {
    ...
    ctaBannerTitle2: 'انضم إلى المنظمة.',
    ctaBannerDesc: 'كلما كنا أكثر، كانت قوتنا التفاوضية أكبر.',
    ctaJoinNow: 'انضم الآن →',
    membershipLabel: 'الانتساب 2025–2026',
    membershipTitle: 'انضم إلى الحركة.',
    membershipDesc: 'انتسابك ليس مجرد اشتراك. إنه فعل تضامن مهني.',
    howToJoin: 'كيفية الانتساب',
    nextStep: 'الخطوة التالية',
    perYear: '/سنة',
